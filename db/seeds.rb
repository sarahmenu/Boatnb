...
user_1 = User.create(first_name: 'Lucas', last_name: 'Vittaz', email: 'lucasvittaz.pro@gmail.com', phone: '0685259877', password: "123456")
user_2 = User.create(first_name: 'Naby', last_name: 'Bathily', email: 'naby.bathily@gmail.com', phone: '0625327730', password: "123456")
user_3 = User.create(first_name: 'Sarah', last_name: 'Menu', email: 'sarah.menu@gmail.com', phone: '0625857768', password: "123456")
user_4 = User.create(first_name: 'Yohann', last_name: 'Lemasson', email: 'yohann.lemasson@gmail.com', phone: '0625987768', password: "123456")
user_5 = User.create(first_name: 'Anthony', last_name: 'Gouvrillon', email: 'anthony.gouvrillon@gmail.com', phone: '0625987766', password: "123456")
user_6 = User.create(first_name: 'Amina', last_name: 'Lagoun', email: 'amina.lagoun@gmail.com', phone: '0633221255', password: "123456")
user_7 = User.create(first_name: 'Antoine', last_name: 'Manceau', email: 'antoine.manceau@gmail.com', phone: '0640123212', password: "123456")
user_8 = User.create(first_name: 'Clément', last_name: 'Spiers', email: 'clement.spiers@gmail.com', phone: '0633221257', password: "123456")
user_9 = User.create(first_name: 'Aurore', last_name: 'Rigault', email: 'aurore.rigault@gmail.com', phone: '0640123444', password: "123456")
...
booking_1 = Booking.create!( boat_id: boat_15.id, user_id: user_4.id, total_price: 3000, start_at: DateTime.parse("24/07/2023"), end_at: DateTime.parse("24/07/2023"))
...
booking_3 = Booking.create( boat_id: boat_12.id, user_id: user_8.id, total_price: 5500, start_at: DateTime.parse("18/08/2023"), end_at:DateTime.parse("24/08/2023"))
